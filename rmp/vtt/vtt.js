...
(function (global) {
  ...
  function CueStyleBox(window, cue, styleOptions) {
    ...
    this.cueDiv.className = "rmp-cc-cue";
    var styles = {
      color: color,
  ...
  var FONT_STYLE = "'Roboto', Arial, sans-serif";
  var CUE_BACKGROUND_PADDING = "1.5%";

  // Runs the processing model over the cues and regions passed to it.
  // @param overlay A block level element (usually a div) that the computed cues
  //                and regions will be placed into.
  WebVTT.processCues = function (window, cues, overlay, forceCompute) {
    ...
    paddedOverlay.className = "rmp-cc-container";
    ...
    var pxFontSize = fontSize * fontScale;
    if (pxFontSize < 14) {
      pxFontSize = 14;
    }
    var fontStyle = pxFontSize + "px " + FONT_STYLE;
    var styleOptions = {
      font: fontStyle
    };
    ...
    (function () {
      ...
      for (var i = 0; i < cues.length; i++) {
        ...
        styleBox.div.className = "rmp-cc-display";
